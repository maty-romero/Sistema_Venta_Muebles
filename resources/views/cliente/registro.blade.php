        ...
        <div class="bg-white p-8 rounded shadow-md max-w-3xl w-full">
            ...
            <form action="{{ route('cliente_store') }}" method="POST" class="grid grid-cols-2 gap-4">
                ...
                <div class="ml-16"> 
                    ...
                    <input id="txtNombreUsuario" name="nombreUsuario" type="text" value="{{ old('nombreUsuario') }}" class="rounded-md mb-4">
                    @error('nombreUsuario')
                        <br>
                    ...
                    <input id="txtEmail" name="email" type="email" value="{{ old('email') }}" class="rounded-md mb-4">
                    @error('email')
                        <br>
                        <small style="color: red">{{ $message }}</small>
                    @enderror
                    ...
                    <input id="txtContrasenia1" name="password" type="password" class="rounded-md mb-4">
                    @error('password')
                        <br>
                        <small style="color: red">{{ $message }}</small>
                    @enderror
                    ...
                    <input id="txtContrasenia2" name="password_confirmation" type="password" class="rounded-md mb-4">
                    ...
                    <input id="txtNombreCliente" name="nombreCliente" value="{{ old('nombreCliente') }}" type="text" class="rounded-md mb-4">
                    @error('nombreCliente')
                        <br>
                        <small style="color: red">{{ $message }}</small>
                    @enderror
                ...
                <div class="ml-16">
                    ...
                    <select id="idCmbTipoCliente" name="cmbTipoCliente" class="font-poppins text-1g rounded-md mb-4">
                    ...
                    <input id="txtDniCuit" name="dni_cuit" value="{{ old('dni_cuit') }}" type="number" class="rounded-md mb-4">
                    @error('dni_cuit')
                        <br>
                        <small style="color: red">{{ $message }}</small>
                    @enderror
                    ...
                    <input id="txtCodigoPostal" name="codigoPostal" value="{{ old('codigoPostal') }}" type="number" class="rounded-md mb-4">
                    @error('codigoPostal')
                        <br>
                        <small style="color: red">{{ $message }}</small>
                    @enderror
                    ...
                    <input id="txtTelefono" name="telefono" value="{{ old('telefono') }}" type="number" class="rounded-md mb-4">
                    @error('telefono')
                        <br>
                        <small style="color: red">{{ $message }}</small>
                    @enderror
                    ...
                    <br>
                    <button type="submit" class="mt-6 bg-gray-800 text-white py-2 px-6 rounded-md text-base">
                        Registrarse
                    </button>
                </div>
            </form>
