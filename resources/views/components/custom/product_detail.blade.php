  ...
  <div class="container mx-auto flex flex-wrap">
    ...
    <div class="lg:w-1/2 w-full lg:px-10 lg:py-6 py-6 px-5 lg:mt-0 bg-[#5690FF]">
      ...
      <div class='grid grid-cols-2 w-fit'>
        <p class="title-font font-medium text-2xl text-gray-900 text-white mr-3">@money($producto->getPrecioDeVenta())
        </p>
        <p class="title-font font-medium text-1xl text-gray-900 text-white mt-auto line-through">
          @money($producto->precio_producto)</p>
      </div>
      <p class="leading-relaxed flex mt-6 items-center text-white pb-2">{{$producto->descripcion}}</p>
      <p class='pb-4 text-white'>Medidas <br> Ancho: {{$producto->ancho}}&emsp;Largo: {{$producto->largo}}&emsp;Alto:
        {{$producto->alto}}
      </p>
      <div class="flex-col">
