...
<div class="flex justify-between ml-1">
    <form id="searchForm" name="searchForm" method="GET" action="/searchProducto">
        ...
        <input id="name" name="name" value="{{isset($input['name'])?$input['name']:''}}"
            class="py-1 pl-2 rounded-lg border-gray-200" placeholder="Buscar nombre">
    </form>

    <a href="{{ route('administrador_create_producto') }}"
        class='bg-gray-800 hover:bg-gray-600 text-white py-2 px-4 rounded-md text-base mr-1'>
        Crear Producto
    </a>
    ...
    <x-custom.table :columnas="['Nombre', 'Tipo', 'Discontinuado', 'Precio', 'Stock', 'Modificacion', '']">
        ...
        <tr>
            ...
            <td
                ...
                <a href="{{ route('administrador_edit_producto', $producto) }}"><svg xmlns="http://www.w3.org/2000/svg"
