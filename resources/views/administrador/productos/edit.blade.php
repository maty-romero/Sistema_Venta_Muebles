...
@section('contenido')
    ...
    @csrf
        ...
        <button type="button" class="mt-5 bg-gray-800 text-white py-2 px-4 rounded-md text-bash"data-bs-toggle="modal" data-bs-target="#myModal">
        Actualizar stock
        </button>
        ...
        <form action="{{ route('producto.updateStock', $producto) }}" method="POST">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <input type="number" name="stock" id="" class="rounded-md mb-5">
