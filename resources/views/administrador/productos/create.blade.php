    ...
    <table>
        ...
        <td>
            ...
            <div class="relative w-[190px] mr-5">
                ...
                <input id="txtPrecio" type="number" class="pl-8 rounded-md mb-5 w-[190px]" name="precio_producto">
        ...
        <td>
            ...
            <input id="txtStockInicial" type="number" class="rounded-md mb-5 mr-5" name="stock">
            @error('stock')
            <br><small style="color: red">{{ $message }}</small>
            @enderror
        </td></tr>
        ...
        <tr><td>
            ...
            <input id="txtAlto" type="number" class="rounded-md mb-6" name="alto">
            @error('alto')
            <br><small style="color: red">{{ $message }}</small>
            @enderror
        </td>
        <td>
            ...
            <input id="txtLargo" type="number" class="rounded-md mb-0 mr-5" name="largo">
            @error('largo')
            <br><small style="color: red">{{ $message }}</small>
            @enderror
        </td>
        <td>
            ...
            <input id="txtAncho" type="number" class="rounded-md mb-0 mr-5" name="ancho">
            @error('ancho')
            <br><small style="color: red">{{ $message }}</small>
            @enderror
        </td></tr>
