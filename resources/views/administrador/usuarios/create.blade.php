...
<div id="contenedor" class="container mx-auto p-6">
    <form action="{{ route('administrador_store_usuario') }}" method="POST">
        ...
        <input id="txtContrasenia1" name="password" type="password" class="rounded-md ">
        @error('password')
            <br>
            <small style="color: red">{{ $message }}</small>
        @enderror
        ...
        <input id="txtContrasenia2" name="password_confirmation" type="password" class="rounded-md ">
