    ...
    <form method="POST" action='{{route("guardar_oferta")}}' enctype="multipart/form-data" class='pl-1 w-full'>
        ...
        <div class='flex float-left border-white border-r-2 pr-5 pt-4 mr-5'>
            ...
            <table class='w-[100px]'>
                ...
                <tr id='imgCombo' class='hidden' accept="image/png, image/jpeg">
                    <td colspan="2" class='w-min'>
                ...
                <tr id='tipoProducto' class='hidden'>
                    <td>
                ...
                <tr id='montoMinimo' class='hidden'>
                    <td>
