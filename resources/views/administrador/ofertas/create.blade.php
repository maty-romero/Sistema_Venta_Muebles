...
@section('contenido')
    <div class='flex float-left border-white border-r-2 lg:pr-10 pt-4'>
    <form action="" class='pl-1 w-full'>
    <table class='w-full'>
    <tr>
    <td>
        <p class="font-poppins text-1g">Tipo de oferta</p>
        <select id="" type="text" class="w-[200px] rounded-md mb-5 mr-10 w-36">
            <option></option>
    ...
    <td>
        ...
        <input type='number' id="" name="" max='90' min='5' class="w-[200px] resize-none rounded-md mb-5 mr-1"> %
    </td>
    </tr>
    <tr>
    <td>
        <p class="font-poppins text-1g">Fecha de inicio</p>
        <input id="" type="date" class="w-[200px] rounded-md mb-5 mr-10">
    </td>
    <td>
    ...
    <td>
        ...
        $ <input type='number' id="" name="" min='1' class="w-[186px] resize-none rounded-md mb-5 mr-1">
    </td>
    </tr>
    <td>
    ...
    <div class='flex flex-col w-max-content max-w-[380px] min-w-[250px] lg:pl-10'>
        <ul class="w-full px-5 mt-4 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg">
            <li class="w-full py-3 h-10 px-4 border-b-2 border-gray-200 rounded-t-lg dark:border-gray-600">A</li>
            <li class="w-full py-3 px-4 h-10 border-b-2 border-gray-200 dark:border-gray-600">B</li>
            <li class="w-full py-3 px-4 h-10 border-b-2 border-gray-200 dark:border-gray-600"></li>
            <li class="w-full py-3 px-4 h-10"></li>
        </ul>
        <button class="mt-5 bg-gray-800 text-white h-12 w-[200px] rounded-md">
            Crear oferta
        </button>
    </div>
@endsection