...
Route::middleware(['auth', 'soloAdm'])->group(function () {
    ...
    Route::get('/ofertas/ver/{oferta}', [OfertaController::class, 'admshow'])->name('administrador_ofertas_show');
    ...
    Route::delete('/ofertas/eliminar/{oferta}', [OfertaController::class, 'destroy'])->name('administrador_delete_ofertas');
